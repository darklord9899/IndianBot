    ...
    if ".afk" not in current_message and "yes" in USER_AFK:  # pylint:disable=E0602
        try:
            await borg.send_message(  # pylint:disable=E0602
                ...
                "My Master has gone for some Important work he is very busy or he is lazy to see your messages🥳🥳🥳"
            )
...
async def _(event):
    ...
    if not USER_AFK:  # pylint:disable=E0602
        ...
        if reason:
            await event.edit(f"My Master is busy, and Reason is {reason}")
        else:
            await event.edit(f"My Master is currently Busy or Asleep ")
